...
class Button(Enablable.Enablable):
    def __init__(self, surface:pygame.Surface, position:tuple[float,float], restore_objects:list[tuple[Drawable.Drawable,int]]|None=None, children:list[Drawable.Drawable,int]|None=None, left_click_action:tuple[Callable[[],None|list[tuple[Drawable.Drawable,int]]],list[any],dict[str,any]]|list|None=None, right_click_action:tuple[Callable[[],None|list[tuple[Drawable.Drawable,int]]],list[any],dict[str,any]]|list|None=None, start_enabled:bool=True) -> None:
    ...
    def is_clicking(self, mouse_position:tuple[int,int]|None=None) -> bool:
        ...
        surface_size = self.get_surface().get_size()
